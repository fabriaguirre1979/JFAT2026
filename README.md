...
║     ╚═╝  ╚═╝     ╚═╝  ╚═╝   ╚═╝   ╚═════╝      ║
║                                                    ║
║     FORWARD DEPLOYED ENGINEER & WEB DEVELOPER      ║
╚══════════════════════════════════════════════════╝</pre>
  <br/>
  <h3 align="center" style="font-family: 'JetBrains Mono', monospace; color: #d97757;">
    <code>~ $ where agriculture meets automation · where drones meet code ~</code>
  </h3>
  <br/>
</div>
...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/GSAP-00D084?style=for-the-badge&logo=greensock&logoColor=white" alt="GSAP"/>
...
**JFAT2026** is the digital port of call for **Fabricio Aguirre T.** — a *Forward Deployed Engineer* whose trajectory spans from agricultural engineering and drone aviation to full-stack software development and LLM agent architectures.
...
```mermaid
graph LR
    A[<b>Hero</b><br/>Identity & Vision] --> B[<b>Pathways</b><br/>Life Journey]
    B --> C[<b>Skills Matrix</b><br/>Categorized Expertise]
    C --> D[<b>Projects</b><br/>Real-World Applications]
    D --> E[<b>Contact</b><br/>Connect & Collaborate]
    
    style A fill:#1a1920,stroke:#c96442,color:#faf9f5
    style B fill:#1a1920,stroke:#d97757,color:#faf9f5
    style C fill:#1a1920,stroke:#e6997a,color:#faf9f5
    style D fill:#1a1920,stroke:#4fc3f7,color:#faf9f5
    style E fill:#1a1920,stroke:#29b6f6,color:#faf9f5
```
...
<div align="center">
  <sub style="font-family: 'JetBrains Mono', monospace; color: #807e75;">
    ...
    <br/><br/>
    <img src="https://img.shields.io/badge/📬_fabriaguirre@gmail.com-d97757?style=flat-square" alt="email"/>
    <img src="https://img.shields.io/badge/🐙_GitHub-fabriaguirre1979-0a0a0f?style=flat-square" alt="github"/>
  </sub>
</div>
